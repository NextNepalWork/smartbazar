									...
									<form id="nav-menu-meta" action="" class="nav-menu-meta" method="post" enctype="multipart/form-data">
										<div id="side-sortables" class="accordion-container">
											<ul class="outer-border">
												...
												<li class="control-section accordion-section open add-product-categories"
                                                        ...
                                                        <div class="accordion-section-content ">
                                                            <div class="inside">
                                                                <div id="products-all" class="products-all" style="max-height: 200px; overflow-y: scroll;">
                                                                    <ul id="product_catchecklist"
                                                                        class="categorychecklist no-list-style pl-none" style="list-style: none;">
                                                                            ...
                                                                            <li>
                                                                                <label class="menu-item-title">
                                                                                    <input type="checkbox"
                                                                                           ...
                                                                                           name="menu-item"
                                                                                           value="{{ route('home.index') . '/category/' . $productCategory->slug }}" data-label="{{ $productCategory->name }}">
