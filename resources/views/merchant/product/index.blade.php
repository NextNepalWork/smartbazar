                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="mini__box text-right">
                                <a href="{{ route('vendor.products.create.new') }}" class="btn btn-default" title="add new">New</a>
                                ...
                                <a  href="{{ route('vendor.products.stock') }}" class="btn btn-default" title="products export"><span class="lnr lnr-upload"></span></a>
                            </div>
                        </div>
                         <div class="col-md-12 col-sm-12">
                            <section class="mini__box">
                                <ul class="liststyle--none">
                                    ...
                                    <li><a href="{{ route('vendor.products.table', 'status='.'published') }}" class="approvedProducts btn btn-success">Published (<span>{{ $published }}</span>)</a></li>
                                    <li><a href="{{ route('vendor.products.table', 'status='.'unpublished') }}" class="approvedProducts btn btn-warning">Unpublished (<span>{{ $unpublished }}</span>)</a></li>
                                    <li><a href="{{ route('vendor.products.table', 'status='.'deleted') }}" class="approvedProducts btn btn-danger">Deleted (<span>{{ $deleted }}</span>)</a></li>
