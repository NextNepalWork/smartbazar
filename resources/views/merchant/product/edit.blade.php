                    ...
                    <section class="add-product__form--left">
                                        ...
                                        <div class="product--info">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div id="seo" class="tab-pane fade">
                                                    ...
                                                    name="meta_keyword">@isset($product->seos->first()->meta_keyword) ? $product->seos->first()->meta_keyword : ''@endisset</textarea>
                                                        <h6 class="help-block">write tags and press ',' to add it</h6>
                                                    </div>
                                                    <h3>Meta Content</h3>
                                                    <div class="uk-margin">
                                                        <textarea class="uk-textarea" name="meta_description" rows="5" placeholder="textarea for meta description">@isset($product->seos->first()->meta_description) ? $product->seos->first()->meta_description: '' @endisset</textarea>
                                                    </div>                                                </div>
                                            </div>
                                        </div>
                                    </section>
                       ...
                       $query->where('roles.id',7);
                                        ...
                                        <section class="description">
                                            ...
                                            <div class="uk-margin">
                                                <textarea class="uk-textarea" name="short_description" rows="5" placeholder="textarea for privacy policy">{{ $product->short_description }}</textarea>
                                            </div>
                                        </section>
                                        <section class="description">
