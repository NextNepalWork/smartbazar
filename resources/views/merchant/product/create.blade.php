                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-7">
                                                <input type="text" class="form-control" name="name"
                                                       ...
                                                       value="{{old('name') ? old('name') : isset($existing) ? isset($existing->name)?$existing->name:''  : ''}}">
                                            </div>
                                                ...
                                                <div class="uk-form-controls">
                                                    <div class="uk-inline">
                                                        ...
                                                        <input id="msg" class="uk-input" type="text"
                                                               name="product_price"
                                                               value="{{old('product_price') ? old('product_price') :isset($existing) ? isset($existing->product_price) ? $existing->product_price:'' : ''}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6 sale--inline">
