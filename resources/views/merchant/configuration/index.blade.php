...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-10">
            ...
            <form action="{{ route('vendor.vendors_details.store') }}" method="post" class="form-horizontal"
                  enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="tab-content content__box content__box--shadow">
                    <div id="home" class="tab-pane fade in active">
                        <legend>General <a data-toggle="tab" href="#menu1" class="btn btn-xs btn-warning pull-right"
                                           style="margin-top: 3px;">Next</a></legend>
                        <fieldset>
                            <div class="form-group @if($errors->has('name')) has-error @endif">
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="@Your Shop"
                                               value="{{ isset($vendor->name) ? $vendor->name : '' }}" disabled/>
                                    </div>
                                    @if($errors ->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inputEmail3"
                                           placeholder="eg Fashion Store" name="type"
                                           value="{{ isset($vendor->type) ? $vendor->type : '' }}" disabled>
                                </div>
                            </div>
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="primary_email" class="form-control"
                                               ...
                                               value="{{ isset($vendor) ? $vendor->primary_email : old('primary_email') }}"
                                               disabled/>
                                    </div>
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="secondary_email" class="form-control"
                                               ...
                                               value="{{ isset($vendor) ? $vendor->secondary_email : old('secondary_email') }}"/>
                                    </div>
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input type="tel" name="primary_phone" class="form-control"
                                               ...
                                               value="{{ isset($vendor) ? $vendor->primary_phone : old('primary_phone') }}"/>
                                    </div>
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input type="tel" name="secondary_phone" class="form-control"
                                               ...
                                               value="{{ isset($vendor) ? $vendor->secondary_phone : old('secondary_phone') }}"/>
                                    </div>
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <textarea name="description" cols="30" rows="10" class="form-control"
                                                  placeholder="@Type here...">{{ isset($vendor) ? $vendor->description : old('description') }}</textarea>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inputEmail3" name="pan_number"
                                           placeholder="PAN Number"
                                           value="{{ isset($vendor->pan_number) ? $vendor->pan_number : '' }}" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label">Tax Clearance No</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inputEmail3" name="tax_clearance"
                                           placeholder="Tax Clerance No"
                                           value="{{ isset($vendor->tax_clearance) ? $vendor->tax_clearance : '' }}"
                                           disabled>
                                </div>
                            </div>
                    ...
                    <div id="menu1" class="tab-pane fade">
                        <legend>Social Links <a data-toggle="tab" href="#menu2"
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="facebook_url" class="form-control"
                                               ...
                                               value="{{ (isset($vendor) && $vendor->socials != null) ? $vendor->socials->first()->facebook_url : '' }}"/>
                                    </div>
                            ...
                            <div class="form-group @if($errors->has('google_url')) has-error @endif">
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="google_url" class="form-control"
                                               placeholder="@Your Google Plus Link"
                                               value="{{ (isset($vendor) && $vendor->socials != null) ? $vendor->socials->first()->google_url : old('google_url') }}"/>
                                    </div>
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="twitter_url" class="form-control"
                                               ...
                                               value="{{ (isset($vendor) && $vendor->socials != null) ? $vendor->socials->first()->twitter_url : old('twitter_url') }}"/>
                                    </div>
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="instagram_url" class="form-control"
                                               placeholder="@Your Instagram Page Link"
                                               value="{{ (isset($vendor) && $vendor->socials != null) ? $vendor->socials->first()->instagram_url : old('instagram_url') }}"/>
                                    </div>
                            ...
                            <div class="form-group @if($errors->has('title')) has-error @endif">
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    @if(isset($vendor) && \App\Model\VendorDocument::where('vendor_detail_id',$vendor->id)->where('title','pan_image')->first())
                                        <a href="{{\App\Model\VendorDocument::where('vendor_detail_id',$vendor->id)->where('title','pan_image')->first()->image}}"
                                           class="product-img-zoom" title="Zoom">

                                            <img src={{\App\Model\VendorDocument::where('vendor_detail_id',$vendor->id)->where('title','pan_image')->first()->image}} alt="pan_image"
                                                 style="width:300px;"></a>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group @if($errors->has('image')) has-error @endif">
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    @if(isset($vendor) && \App\Model\VendorDocument::where('vendor_detail_id',$vendor->id)->where('title','company_image')->first())
                                        <a href="{{\App\Model\VendorDocument::where('vendor_detail_id',$vendor->id)->where('title','company_image')->first()->image}}"
                                           class="product-img-zoom" title="Zoom">
                                            <img src={{\App\Model\VendorDocument::where('vendor_detail_id',$vendor->id)->where('title','company_image')->first()->image}} alt="pan_image"
                                                 style="width:300px;"></a>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group @if($errors->has('image')) has-error @endif">
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    @if(isset($vendor) && \App\Model\VendorDocument::where('vendor_detail_id',$vendor->id)->where('title','signature_image')->first())
                                        <a href="{{\App\Model\VendorDocument::where('vendor_detail_id',$vendor->id)->where('title','signature_image')->first()->image}}"
                                           class="product-img-zoom" title="Zoom">
                                            <img src={{\App\Model\VendorDocument::where('vendor_detail_id',$vendor->id)->where('title','signature_image')->first()->image}} alt="pan_image"
                                                 style="width:300px;"></a>
                                    @endif
                                </div>
                            </div>
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="seo_keywords" class="form-control"
                                               ...
                                               value="{{ (isset($vendor) && $vendor->seos != null) ? $vendor->seos->first()->seo_keywords : old('seo_keywords') }}"/>
                                    </div>
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <textarea name="seo_description" cols="30" rows="10" class="form-control"
                                                  placeholder="@Meta description...">{{ (isset($vendor) && $vendor->seos != null) ? $vendor->seos->first()->seo_description : old('seo_description') }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-9 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="category" class="form-control" placeholder="@Category"
                                               value="{{ (isset($vendor) && $vendor->category != null) ? $vendor->category->first()->category : old('category') }}"/>
                                    </div>
        ...
        <div class="col-lg-4 col-md-3 col-sm-10">
            <h2>Company Display Image</h2>

            <ul class="nav nav-tabs tab-custom-style">
                <li class="active"><a data-toggle="tab" href="#home">Company Image</a></li>

            </ul>


            <form action="{{ route('vendor.vendors_details.company-image') }}" method="post" class="form-horizontal"
                  enctype="multipart/form-data">
                {{ csrf_field() }}
                @if(\App\Model\VendorCompanyImage::where('vendor_details_id',$vendor->id)->first())
                    <div class="form-group @if($errors->has('title')) has-error @endif">
                        <label class="col-md-3 control-label">Current Image</label>
                        <div class="col-md-9 inputGroupContainer">
                            <img src={{asset('vendor_company_image/'.\App\Model\VendorCompanyImage::where('vendor_details_id',$vendor->id)->first()->image)}} alt="pan_image"
                                 style="width:300px;"></a>
                        </div>
                    </div>
                @endif
        ...
        <div class="col-lg-4 col-md-3 col-sm-10">
            ...
            <form action="{{ route('vendor.vendors_details.cover-image') }}" method="post" class="form-horizontal"
                  enctype="multipart/form-data">
                {{ csrf_field() }}
                @if(\App\Model\VendorCoverImage::where('vendor_details_id',$vendor->id)->first())
                    <div class="form-group @if($errors->has('title')) has-error @endif">
                        <label class="col-md-3 control-label">Current Image</label>
                        <div class="col-md-9 inputGroupContainer">
                            <img src={{asset('vendor_cover_image/'.\App\Model\VendorCoverImage::where('vendor_details_id',$vendor->id)->first()->cover_image)}} alt="pan_image"
                                 style="width:300px;"></a>
                        </div>
                    </div>
                @endif
