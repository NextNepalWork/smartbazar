        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6" style="margin-bottom:10px;">
                <div class="panel panel-yellow">
                    ...
                    <a href="{{ url('/admin/order?status=all') }}">
                                        ...
                                        @foreach($latest_orders as $order)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    by <a href="">{{ $order->user != null ? $order->user->user_name :'' }}</a><br> <a
                                                            href="">{{ $order->user!= null ? $order->user->email :'' }}</a></td>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($latest_negotiables as $negotiable)
                                            <tr>
                                                ...
                                                <td>{{ $negotiable->user!= null? isset($negotiable->user->user_name)?$negotiable->user->user_name:'':'' }}</td>
                                                                                             <td>{{ isset($negotiable->product->users->user_name)? $negotiable->product->users->email :''}}</td>
