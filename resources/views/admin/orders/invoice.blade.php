                    ...
                    <div class="panel-body" style="padding: 10px;">
                        <ul class="liststyle--none" style="margin: 0;">
                            ...
                            <li>
                                ...
                                <span>{{ $userDetails->mobile }}{{ $userDetails->phone != null ? ',' . $userDetails->phone : '' }}</span>
                            </li>
                            <li>
                                <strong>Email:</strong>
        ...
        <table class="table table-bordered">
            ...
            @foreach($products = $order->orderProduct as $product)
                @php
                    ...
                    if(isset($order->prebookings)) {
                        $productSubTotal_ = $product->price - $order->prebookings->price;
                    }
                    else {
            ...
            @endphp
            <tr>
                <td colspan="2" class="text-right">Subtotal @if(isset($order->prebookings)) (90% of Preorder) @endif</td>
                <td class="text-center">Rs. {{ $productSubTotal_ }}</td>
            </tr>
            <tr>
                <td colspan="2" class="text-right">Tax amount</td>
                <td class="text-center">Rs. {{ $taxAmount_ }}</td>
            </tr>
            <tr>
                <td colspan="2" class="text-right">Discount</td>
                <td class="text-center">Rs. {{ $discountAmount_ }}</td>
            </tr>
            <tr>
