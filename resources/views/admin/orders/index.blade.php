            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <!--<h3 class="box-title">All Orders <small>({{ $ordersCount }})</small></h3>-->
                        ...
                        <a href="{{ route('admin.export.excel') }}" class="btn btn-sm btn-success pull-right" style="margin: 10px 3px;">Excel Export</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
...
@push('scripts')
    ...
    <script>
        ...
        $(document).on('click', '.order_checkbox', function () {
            ...
            var url = "{{ route('admin.export.selected') }}?" + $.param(query)
