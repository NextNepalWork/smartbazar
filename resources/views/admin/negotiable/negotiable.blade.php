                ...
                <table class="table table-bordered" id="negotiableTable">
                    ...
                    @foreach($negotiables as $nego_product)
                        <tr>
                            ...
                            <td>{{isset( $nego_product->user->user_name) ? $nego_product->user->user_name :'' }}</td>
                            ...
                            <td>
                                @if($nego_product->fixed_price == null)
                                    <form method="post" action="{{route('admin.negotiable.fix_price')}}">
                                        {{csrf_field()}}
                                        <input type="hidden" name="negotiable_id" value="{{$nego_product->id}}">
                                        <input type="number" class="form-control"
                                              name="fixed_amount" placeholder="Final Price">
                                        <button class="btn btn-sm" type="submit">Fix
                                        </button>
                                    </form>
                            ...
                            <td>
                                <a class="btn btn-default btnMenu request"
                                   href="{{ route('admin.negotiable.details',$nego_product->id) }}">Negotiate</a>
                            </td>
                        </tr>
                    @endforeach
