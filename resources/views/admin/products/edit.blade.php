...
@section('content')
    ...
    <form class="uk-form-horizontal uk-margin-large" action="{{route('admin.products.update')}}" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-9">
                                                <h3>Your Selected Category: <span style="color: red"> <input type="text"
                                                                                                             value="{{ $product->categories->isNotEmpty() ? $product->categories->first()->name : '' }}"
                                                                                                             id="category_name"
                                                                                                             class="product--hidden-category"
                                                                                                             readonly/></span>
                                                </h3>
                                        ...
                                        <div class="product--info">
                                            ...
                                            <div class="tab-content">
                                                            ...
                                                            <div class="form-group pad-20">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <select class="form-control" name="stock">
                                                                        <option value="1"
                                                                                @if($product->stock == 1) selected @endif>
                                                                            In Stock
                                                                        </option>
                                                                        <option value="0"
                                                                                @if($product->stock == 0) selected @endif>
                                                                            Out of Stock
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                ...
                                                <div id="seo" class="tab-pane fade">
                                                    <h3>Meta Keywords</h3>
                                                    <div class="tag--input">
                                                    <textarea value="" data-role="tagsinput" class="form-control"
                                                              style="width: 100%;"
                                                              name="meta_keyword">@isset($product->seos->first()->meta_keyword)
                                                            ? $product->seos->first()->meta_keyword :
                                                            ''@endisset</textarea>
                                                        <h6 class="help-block">write tags and press ',' to add it</h6>
                                                    </div>
                                                    <h3>Meta Content</h3>
                                                    <div class="uk-margin">
                                                        <textarea class="uk-textarea" name="meta_description" rows="5"
                                                                  placeholder="textarea for meta description">@isset($product->seos->first()->meta_description)
                                    ...
                                    <section class="simple__box">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <select name="approved" class="form-control">
                                                    <option value="1" @if($product->approved == 1) selected @endif>
                                                        Approved
                                                    </option>
                                                    <option value="0" @if($product->approved == 0) selected @endif>
                                                        Pending
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid sale--inline">
                                                <label>
                                                    <input class="uk-checkbox" type="checkbox" name="prebooking"
                                                           value="1" @if($product->prebooking == 1) checked @endif>Check
                                                    here if this item is a prebooking item or comming soon item?
                                                </label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid sale--inline">
                                                <label>
                                                    <input class="uk-radio" type="radio" name="negotiable" value="1"
                                                           @if($product->negotiable == 1) checked @endif>Available
                                                </label>
                                                <label>
                                                    <input class="uk-radio" type="radio" name="negotiable" value="0"
                                                           @if($product->negotiable == 0) checked @endif>Unavailable
                                                </label>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid sale--inline">
                                                <label>
                                                    <input class="uk-radio" type="radio" name="super_store_status" value="1"
                                                           @if($product->super_store_status == 1) checked @endif>Available
                                                </label>
                                                <label>
                                                    <input class="uk-radio" type="radio" name="super_store_status" value="0"
                                                           @if($product->negotiable == 0) checked @endif
                                                           checked>Unavailable
                                                </label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid sale--inline">
                                                <label>
                                                    <input class="uk-radio" type="radio" name="quality"
                                                           ...
                                                           @if($product->quality == 'Genuine Product') checked @endif>Genuine
                                                    Product
                                                </label>
                                                <label>
                                                    <input class="uk-radio" type="radio" name="quality"
                                                           value="Quality Assurence"
                                                           @if($product->quality == 'Quality Assurence') checked @endif>Quality
                                                    Assurence
                                                </label>
                                                <label>
                                                    <input class="uk-radio" type="radio" name="quality"
                                                           value="Clone Product"
                                                           @if($product->quality == 'Clone Product') checked @endif>Clone
                                                    Product
                                                </label>
                                                <label>
                                                    <input class="uk-radio" type="radio" name="quality"
                                                           value="Standard Product"
                                                           @if($product->quality == 'Standard Product') checked @endif>Standard
                                                    Product
                                                </label>
                                            </div>
                                        </div>
                                        <section class="description">
                                            ...
                                            <div class="uk-margin">
                                                <textarea class="uk-textarea form-control" name="short_description"
                                                          rows="5"
                                                          placeholder="textarea for privacy policy">{{ $product->short_description }}</textarea>
                                            </div>
                                        </section>
                                        <section class="description">
                                                    ...
                                                    @foreach($product->additionals as $additional)
                                                        <tr data-row="{{ $loop->iteration }}">
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    <input type="number"
                                                                           name="additionals[quantity][{{ $additional->id }}]"
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    <input type="text"
                                                                           name="additionals[size][{{ $additional->id }}]"
                                                            ...
                                                            <td>
                                                                <button type="button"
                                                                        class="btn btn-danger btn-xs btn-delete-color"
                                                                        data-color="{{ $additional->id }}"><i
                                                                            class="fa fa-trash"></i>
                                                                </button>
                                                            </td>
                                                        </tr>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status" id="publish">
                                                <option value="published"
                                                        @if($product->status == 'published') selected @endif>Publish
                                                </option>
                                                <option value="unpublished"
                                                        @if($product->status == 'unpublished') selected @endif>Unpublish
                                                </option>
                                            </select>
                                        </div>
                                    </div>
