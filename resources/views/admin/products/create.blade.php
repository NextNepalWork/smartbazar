                                        ...
                                        <div class="product--info">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div id="seo" class="tab-pane fade">
                                                    <h3>Meta Keywords</h3>
                                                    <div class="tag--input">
                            <textarea value="" data-role="tagsinput" class="form-control" style="width: 100%;"
                                      name="meta_keyword" value="{{old('meta_keyword')}}"></textarea>
                                                        <h6 class="help-block">write tags and press ',' to add it</h6>
                                                    </div>
                                                    <h3>Meta Content</h3>
                                                    <div class="uk-margin">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-7">
                                                <input type="text" class="form-control" name="name"
                                                       ...
                                                       value="{{ isset($existing) ? $existing->name : old('name')}}">
                                            </div>
                                            <div class="col-md-5">
                                                ...
                                                <div class="uk-form-controls">
                                                    <div class="uk-inline">
                                                        ...
                                                        <input id="msg" class="uk-input form-control" type="text"
                                                               name="product_price"
                                                               value="{{isset($existing) ? $existing->product_price :old('product_price') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6 sale--inline">
                                                <div class="uk-form-controls">
                                                    <div class="uk-inline">
                                                        ...
                                                        <input id="msg" class="uk-input form-control" type="text"
                                                               name="sale_price"
                                                               value="{{isset($existing) ? $existing->sale_price :old('sale_price') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6 sale--inline">
                                            ...
                                            <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid sale--inline">
                                                <label>
                                                    <input class="uk-checkbox" type="checkbox" name="prebooking"
                                                           @if(old('prebooking')) checked @endif value="1">Check here if
                                                    this item is a prebooking item or comming soon item?
                                                </label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid sale--inline">
                                                ...
                                                <label>
                                                    <input class="uk-radio" type="radio" name="negotiable" value="0"
                                                           @if(old('negotiable') == 0) checked @endif
                                                    >Unavailable
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <section class="description">
                                            ...
                                            <div class="uk-margin">
                                                <textarea class="uk-textarea form-control" name="short_description"
                                                          rows="5"
                                                          placeholder="textarea for privacy policy">{{isset($existing) ? $existing->long_description : old('short_description')}}</textarea>
                                            </div>
                                        </section>
                                        <section class="description">
                                            <div class="title">long description</div>
                                            <textarea class="longdescrip"
                                                      name="long_description">{{isset($existing) ? $existing->long_description :old('long_description') }}</textarea>
                                        </section>
                                    </section>
                                </div>
    ...
    <script>
        ...
        jQuery(document).on('click', '.product-image-list .is_main_image_button', function (e) {
            ...
            if (jQuery(this).hasClass('active')) {
                ...
                var add = jQuery(this).parents('.image-preview:first').find('.is_main_image_hidden_field').val(1);
