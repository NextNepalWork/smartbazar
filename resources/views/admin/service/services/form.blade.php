	...
	@section('content')
		...
		<section>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<form action="{{ route('admin.services.store')  }}" enctype="multipart/form-data" id="serviceCategory" method="post">
						{{csrf_field()}}
						...
						<div class="form-group">
							...
							<textarea class="longdescrip" name="description"></textarea>
						</div>
						<div class="row">
							<div class="col-md-6">
						...
						<button type="submit" name="submit">Add Service Category</button>
					</form>
				</div>
			</div>
		</section>
