...
@section('content')
	<div class="row  ">
		...
		<!--	</div>-->
		<!--@endif-->
		<div class="col-md-6 offset-md-3 col-sm-6 offset-sm-3 col-xs-offset-8 col-xs-offset-2 box-shadow mt-2 mb pb-3">
		    <div class="py-3">
			...
			<form action="{{ route('request.product') }}" method="post">
				...
				<div class="form-group {{ $errors->has('product_specification') ? 'has-error':'' }}">
					...
					<textarea name="product_specification" id="pro_specification" cols="100" rows="10" class="uk-textarea" placeholder="Let us know the product specification"></textarea>
				...
				<input type="submit" name="submit" value="Submit Request" class="uk-button btn-success btn-block">
			</form>
		</div>
	</div>
@endsection