            ...
            <div class="row crows py-5">
                <div class="col-md-10">
                    <div class="row crows">
                        ...
                        <div class="col-sm-7 box-shadow p-2">
                            <div class="product--reveal__right">
                                <div class="product--header">
                                    <div class="product__title font-weight-bold">
                                ...
                                <div class="product--details product--details--return">
                                    <ul class="liststyle--none">
                                        <li><span class="font-weight-bold">Sold by : </span><span class="link-2 text-danger font-weight-bold">Gold Star</span>
                                        </li>
                                ...
                                <form action="{{ route('order_return.message.store') }}" method="post">
                                    ...
                                    <div class="product--description__title font-weight-bold return-product-topic {{ $errors->has('topic_id') ? ' has-error' : '' }}">
                                    ...
                                    <div class="from-group {{ $errors->has('return_message') ? ' has-error' : '' }}">
                                        <div class="product--details product--details--return">
                                            <ul class="liststyle--none">
                                                <li><span class="font-weight-bold">Your Reason * </span>
                                                </li>
