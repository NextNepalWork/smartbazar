        ...
        <div class="container box-shadow mb mt-3">
            ...
            <div class="row ">
                ...
                <div class="input-cart col-md-6 ">
                    ...
                    <form action="{{route('sell.post')}}" name="signup" method="post" autocomplete="off"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="uk-margin">
                                            <div class="uk-inline uk-width-1-1">
                                                <span class="uk-form-icon" uk-icon="icon: lock"></span>
                                                <input class="uk-input" name="type" value="{{old('type')}}" type="text"
                                                       required="required"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="uk-margin">
                                            ...
                                            <div class="uk-inline uk-width-1-1">
                                                ...
                                                <input class="uk-input" value="{{old('phone')}}" name="phone"
                                                       type="text" required="required" value="{{ $user->phone }}"
                                                       required="required">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="uk-margin">
                                            <div class="uk-inline uk-width-1-1">
                                                ...
                                                <input class="uk-input" name="address" value="{{old('address')}}"
                                    ...
                                    <div class="col-sm-12">
                                        <button type="button" class="uk-button btn-success pull-right"
                                                id="vendor-continue">Continue <span uk-icon="arrow-right"></span>
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="uk-margin">
                                        ...
                                        <div class="uk-inline uk-width-1-1">
                                            <input class="uk-input" name="pan_number" value="{{old('pan_number')}}"
                                                   type="text" required="required" placeholder="Pan Number">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="uk-margin">
                                        ...
                                        <div class="uk-inline uk-width-1-1">
                                            <input class="uk-input" name="tax_clearance" type="text"
                                                   value="{{old('tax_clearance')}}" required="required"
                                ...
                                <div class="col-sm-12">
                                    <div class="uk-margin">
                                        ...
                                        <select class="form-control">
                                            <option>Inclusive -2000</option>
                                            <option>Exclusive -5000</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="uk-margin">
                                        <label class="uk-form-label" for="form-stacked-select"> Pan No. Registration
                                            *</label>
                                ...
                                <div class="col-sm-12">
                                    <div class="uk-margin">
                                        <label class="uk-form-label" for="form-stacked-select"> Signature Image
                                            *</label>
                                        <!--<div class="uk-inline uk-width-1-1" uk-form-custom>-->
