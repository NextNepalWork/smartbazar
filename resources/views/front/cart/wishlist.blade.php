    ...
    <section class="cartpage-container uk-margin-bottom">
        <div class="container">
            <section class="row breadcrumbs max-inner">
                <div class="columns col-12 py-4">
                    <ul class="breadcrumb-list mx-auto d-block text-center">
                        <h1 class="">Wishlist</li>
                    </ul>
                </div>
            </section>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="" method="post">
                            <table class="uk-table uk-table-divider shop_table table table-bordered" cellspacing="0">
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-remove ">
                                                <a href="javascript:void(0)" data-row="{{ $wishlist->id }}" data-product="{{ $wishlist->product->id }}"
                                                   class="remove btn-remove-row remove_from_wishlist  btn btn-danger"
