...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany(SuperVendorReferral::class);
    }

    public function storeReferrals()
    {
        return $this->hasMany(ReferralAmountSuper::class, 'super_vendor_id');
    }

    public function SuperWallet()
    {
        return $this->hasMany(VendorWallet::class, 'super_vendor_id');

    }
    public function superCustomer_referrals()
    {
        return $this->hasMany(SuperCustomerAmount::class,'super_customer_id');
    }
    public function SuperCustomerWallet()
    {
        return $this->hasMany(SuperCustomerWallet::class, 'super_customer_id');
