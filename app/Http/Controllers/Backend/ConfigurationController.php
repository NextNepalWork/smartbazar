...
class ConfigurationController extends Controller
{
    ...
    public function postConfiguration(Request $request)
    {
        ...
        foreach ($inputs as $inputKey => $inputValue) {
            if ($inputKey == 'site_logo' || $inputKey == 'site_favicon' || $inputKey == 'email_logo' || $inputKey == 'footer_logo' || $inputKey == 'payments_logo' || $inputKey == 'ad' || $inputKey == 'category_ads_image_1' || $inputKey == 'category_ads_image_2' || $inputKey == 'category_ads_image_3' || $inputKey == 'category_ads_image_4') {
                $file = $inputValue;
                // Delete old file
