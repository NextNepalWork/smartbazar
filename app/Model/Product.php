...
class Product extends Model
{
    ...
    public function store_referrals()
    {
        return $this->hasMany(StoreReferralLink::class, 'product_id');
    }
     public function negotiables(){
        return $this->hasMany(Negotaible::class,'product_id');
    }
}
