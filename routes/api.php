...
Route::group([
    ...
    Route::get('/product-section', 'HomeController@product_section')->name('product-section');
    Route::get('/mall-profile', 'HomeController@mall_profile')->name('mall-profile');
    Route::get('/mall-products', 'HomeController@mall_products')->name('mall-products');
    Route::get('/side-category', 'HomeController@side_category')->name('side-category');
    ...
    Route::get('/services-home', 'ServiceController@home');
    Route::get('/services/slideshows', 'ServiceController@getSlideshows');
    Route::get('/services/categories', 'ServiceController@getCategories');
    Route::get('/services/ad', 'ServiceController@getServiceAd');
    Route::get('/category/{id}/services', 'ServiceController@getCategoryServices');
    Route::get('/service/{id}', 'ServiceController@getServiceDetails');
    Route::get('/service/reviews/{id}', 'ServiceController@getServiceReviews');
    Route::get('/related-services/{id}', 'ServiceController@getRelatedServices');
    Route::post('/service-request', 'ServiceController@storeServiceOrder');
    Route::get('/service-search', 'ServiceController@searchServices');
    ...
    Route::group([
        ...
        Route::group(['prefix' => 'negotiable'], function () {
            Route::post('/add-negotiable', 'NegotiableController@add_negotiable');
            Route::get('/all-negotiable', 'NegotiableController@all_negotiable');
            Route::get('/view-negotiable','NegotiableController@view_negotiable');
            Route::post('/send-message', 'NegotiableController@send_message');
                        Route::get('/delete-negotiable', 'NegotiableController@delete_negotiable');
                                    Route::get('/delete-negotiable', 'NegotiableController@delete_negotiable');
